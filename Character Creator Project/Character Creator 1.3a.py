...
def imports():
    """Importing Function"""
    imported=open("Character.dat", "rb")
    ...
    LUK=data[6]
    INT=data[7]
    charimport=[Name, Gender, Class, STR, DEF, AGI, LUK, INT]
    return charimport
    imported.close()
...
--------------------------
        ...
        print("\n--------------------------------\n")
        print("\nThis is the character exporter, which writes the data of your character to a    file.")
        print("\nWARNING! THERE MAY BE ONLY ONE CHARACTER PER FILE,SO BACK UP ANY YOU DO NOT WISHTO OVERWRITE!")
        exploop=True
        while exploop==True:
            exp=str(input("\nExport current saved character data? [y/n] "))

...
def export():
    ...
    INTE=INT
    exports.write(Name)
    exports.write(Gender)
    exports.write(Class)
    exports.write(str(STRE))
    exports.write(str(DEFE))
    exports.write(str(AGIE))
    exports.write(str(LUKE))
    exports.write(str(INTE))
